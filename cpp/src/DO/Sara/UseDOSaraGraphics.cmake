if(SARA_USE_FROM_SOURCE)
  get_property(DO_Sara_Graphics_ADDED GLOBAL
               PROPERTY _DO_Sara_Graphics_INCLUDED)
  if(NOT DO_Sara_Graphics_ADDED)
    ...
    target_include_directories(
      DO_Sara_Graphics PUBLIC ${DO_Sara_INCLUDE_DIR} #
    ...
    target_compile_definitions(
      DO_Sara_Graphics
      PUBLIC $<$<PLATFORM_ID:Darwin>:GL_SILENCE_DEPRECATION>
      PRIVATE $<$<COMPILE_LANG_AND_ID:CXX,MSVC>:/wd26812>)
