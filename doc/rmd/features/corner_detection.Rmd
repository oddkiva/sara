...
:::fyi
OK, I agree this is not the real intuition that lecture or publications start
...
:::note
I will add a few more paragraphs about Moravec's corner detector, which Harris
improves.

- Moravec's main idea is to localize pixels where a small shift in any
  direction induces a large change of intensity.
- Harris improves Moravec's idea by using a Taylor expansion, which will make
  the structure tensor appear.
:::
