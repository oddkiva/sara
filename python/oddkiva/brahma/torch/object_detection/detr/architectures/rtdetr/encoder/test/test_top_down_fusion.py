...
def test_top_down_fusion():
    ...
    #     F_yellowed.append(lateral_conv(F_coarse))
    #     # Check the lateral convolution
    #     lateral_conv_out = F_yellowed[-1]
    ...
    #     FS_together = torch.concat((F_coarse_upscaled, S_fine), dim=1)
    #     F_fine = fpn[num_steps - 1 - step](FS_together)
    #     F_enriched.append(F_fine)

    #     fpn_out = F_enriched[step + 1]
    #     fpn_out_true = fpn_outs_true[step + 1]
