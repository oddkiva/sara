...
\begin{equation}
  \lambda_i^2 + \lambda_j^2 - 2 \mathbf{y}_i^\top \mathbf{y}_j \lambda_i \lambda_j
...
\begin{equation}
  b_{ij} = \mathbf{y}_i^\top \mathbf{y}_j
\end{equation}

We can rewrite these into quadratic matrix form as
\begin{equation}
  \mathbf{\Lambda}^\top \mathbf{M}_{ij} \mathbf{\Lambda} = a_{ij}
\end{equation}
...
- Each of them represents parabolic, elliptic or hyperbolic cylinders since in
  ...
  \mathbf{y}_i^\top \mathbf{y}_j \leq 1$
...
\begin{equation}
  \mathbf{\Lambda}^\top \mathbf{D}_i \mathbf{\Lambda} = 0
\end{equation}
...
\begin{equation}
  \mathbf{\Lambda}^\top \mathbf{D}_0 \mathbf{\Lambda} = 0.
\end{equation}
...
\begin{aligned}
  c_3 &=& \det \mathbf{D}_2 \\
  c_2 &=& \mathbf{D}_{10}^\top (\mathbf{D}_{21} \times \mathbf{D}_{22}) \\
      &+& \mathbf{D}_{11}^\top (\mathbf{D}_{22} \times \mathbf{D}_{20}) \\
      &+& \mathbf{D}_{12}^\top (\mathbf{D}_{20} \times \mathbf{D}_{21}) \\
  c_1 &=& \mathbf{D}_{20}^\top (\mathbf{D}_{11} \times \mathbf{D}_{12}) \\
      &+& \mathbf{D}_{21}^\top (\mathbf{D}_{12} \times \mathbf{D}_{10}) \\
      &+& \mathbf{D}_{22}^\top (\mathbf{D}_{10} \times \mathbf{D}_{11}) \\
  c_0 &=& \det \mathbf{D}_1 \\
\end{aligned},
\end{equation}
...
\begin{equation}
  \mathbf{\Lambda}^\top \mathbf{D}_1 \mathbf{\Lambda} = 0
\end{equation}
