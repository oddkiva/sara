...
The real motivation that made me learn want to learn about R is because of the R
*bookdown* package [@xie:2020:bookdown], [@xie:2021:bookdown]. Compared to
Sphinx documentation, This package is so stunning in terms of:

1. pretty default yet customizable aesthetics,
2. natural $\LaTeX$ support,
3. and most of all *multilanguage capabilities*, particularly C++^[C++ support is
   ...
   more than sufficient for the demonstration purposes in practice. In
   particular, Eigen [@eigenweb] is supported by the existing package RccEigen
...
With the excitement and frustration as a newbie, it took me a few days to
experiment and eventually port the documentation little by little by finding the
useful information bits gleaned here and there in StackOverflow, GitHub and
elsewhere instead of the original documentation.

Namely the bookdown package implements *literate programming*, a term coined by
[@knuth:1984:lp].
...
### Starting Point: One Working Example Code
