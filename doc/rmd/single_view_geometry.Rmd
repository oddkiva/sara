...
[@HartleyZ:2003:mvg]. This was a not easy and slow process but it turned out to
...
important topic. In my humble opinion, this is bad and will harm the advances in
computer vision research. With the popularization of deep-learning approaches,
my main concern is that this will become worse.
...
```{r, child="singleviewgeometry/gaussian_sphere.Rmd"}
```
