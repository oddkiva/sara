...
\begin{equation}
  \mathbf{M}(\mathbf{x}) = \begin{bmatrix}
    \displaystyle \int w(\mathbf{x}') \frac{\partial I (\mathbf{x} -
    \mathbf{x}')}{\partial x}^2 d\mathbf{x'}&&
    %
    \displaystyle \int w(\mathbf{x})
    \frac{\partial I(\mathbf{x} - \mathbf{x}')}
         {\partial x}
    \frac{\partial I(\mathbf{x} - \mathbf{x}')}
    ...
    %
    \displaystyle \int w(\mathbf{x}')  \frac{\partial I (\mathbf{x} -
    \mathbf{x}')}{\partial y}^2 d\mathbf{x'}&&
  \end{bmatrix}
\end{equation}
