...
Let us detail how we go from the camera coordinates $(O_C, \mathbf{i}_C,
\mathbf{j}_C,\mathbf{k}_C)$ to the world coordinates $(O_W, \mathbf{i}_W,
\mathbf{j}_W,\mathbf{k}_W)$. We assume the basis vectors are *orthonormal* and
