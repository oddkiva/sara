...
namespace DO { namespace Sara {
  ...
  void draw_line_segment(const LineSegment& s, const Rgb8& c, int pen_width)
  {
    draw_line(s.p1(), s.p2(), c, pen_width);
  }

  void draw_bbox(const BBox& b, const Rgb8& color, int pen_width)
  {
  ...
  void draw_ellipse(const Ellipse& e, const Rgb8& col, int pen_width)
  {
    // Ellipse...
