## A Use Case for Animal Conservation

Visual metrology and distance calculation are important problems that must be
treated carefully in autonomous driving systems to guarantee the safety of
pedestrians.

But this can also be useful too for animal conservation. So instead of talking
about road safety which is already widely treated in the computer vision
industry, let us to see how these problems could be used to protect animals and
monitor their demographics as an attempt to bring more awareness and justice to
environmental and wildlife topics.
