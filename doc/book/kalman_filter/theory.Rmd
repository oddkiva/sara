...
A pedestrian is either standing up still or walking. He is neither sitting on a
bench, nor lying on the floor. We can therefore represent that pedestrian with a
3D cylindric bounding box $\mathbf{b} = (x, y, a, h)$.
