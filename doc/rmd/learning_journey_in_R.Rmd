...
#### Geometry Rendering
Moving onto the rendering, let's make the viewing domain will be slightly larger
than the patch region:
...
plot(x_view_min_max, y_view_min_max, type = "n", xlab = "x", ylab = "y",
...
```{r, animation.hook="gifski", interval=0.1, cache=TRUE}
op <- par(bg = "#f7f7f7", pty="s")
...
We have completed the most challenging part of this mini-project, which is to
...
rewarding and most of all, it has highlighted how visual communication remains
an art.
