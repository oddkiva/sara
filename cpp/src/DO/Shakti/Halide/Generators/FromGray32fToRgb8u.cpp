...
namespace {
  ...
  class Gray32fToRgb8u : public Halide::Generator<Gray32fToRgb8u>
  {
  public:
...
HALIDE_REGISTER_GENERATOR(Gray32fToRgb8u, shakti_gray32f_to_rgb8u_cpu)
HALIDE_REGISTER_GENERATOR(Gray32fToRgb8u, shakti_gray32f_to_rgb8u_gpu)
