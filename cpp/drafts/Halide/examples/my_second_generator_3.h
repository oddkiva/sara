#ifndef HALIDE_____my_second_generator_3_h
#define HALIDE_____my_second_generator_3_h
#include <stdint.h>
...
int my_second_generator_3(uint8_t _offset, struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int my_second_generator_3_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *my_second_generator_3_metadata() HALIDE_FUNCTION_ATTRS;
