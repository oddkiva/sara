...
narrative through my learning journey. First, this naturally makes sense to me
as I consider myself as a computer vision practitioner that is continuously
learning and  willing to acknowledge things that I misunderstood. Second, an
impersonal style would just sound boring and not particularly engaging to
younger or less experimented readers that are eager to learn. In this book, I
aim at detailing more the mathematical contents without sacrificing the
experimental aspect of computer vision. Too often, publications will
understandably gloss over mathematical or experimental aspects to sell more the
novelty or performance of their approaches, I have decided to take the time to
detail these for algorithms and methods that I understand well.
...
find any, __please please please__ report back to me and take to explain to me.*
...
The book chooses to emphasize more on the mathematical details to explain
regarding my algorithmic implementations. I believe that my API is most of the
time straightforward enough (hopefully!).
