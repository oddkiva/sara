...
- In the original coordinate system $(x, y, z)$, its coordinates are
  ...
  \begin{align*}
    (\mathbf{R}_z^\top \mathbf{v}) &= \mathbf{R}_y\ (\mathbf{R}_z^\top \mathbf{u})  \\
    \mathbf{v} &= \mathbf{R}_z \mathbf{R}_y \mathbf{R}_z^\top\ \mathbf{u}
  \end{align*}
...
\begin{equation}
  \mathbf{R}_{x''} = \mathbf{R} \mathbf{R}_{x} \mathbf{R}^\top
\end{equation}
...
\begin{equation}
  \mathbf{R}_{x''} = \mathbf{R}_z \mathbf{R}_y \mathbf{R}_{x} \mathbf{R}_y^\top \mathbf{R}_z^\top
\end{equation}
