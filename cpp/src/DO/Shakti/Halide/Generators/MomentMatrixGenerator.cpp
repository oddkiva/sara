...
HALIDE_REGISTER_GENERATOR(MomentMatrix, shakti_moment_matrix_32f_cpu)
HALIDE_REGISTER_GENERATOR(MomentMatrix, shakti_moment_matrix_32f_gpu)
HALIDE_REGISTER_GENERATOR(Cornerness, shakti_cornerness_32f_cpu)
HALIDE_REGISTER_GENERATOR(Cornerness, shakti_cornerness_32f_gpu)
