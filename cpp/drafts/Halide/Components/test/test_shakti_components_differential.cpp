...
BOOST_AUTO_TEST_CASE(test_laplacian)
{
  ...
  auto del_f = Func{};
  del_f(x, y) = DO::Sara::HalideBackend::laplacian(f, x, y);
...
BOOST_AUTO_TEST_CASE(test_hessian)
{
  ...
  auto df = Func{};
  df(x, y) = DO::Sara::HalideBackend::hessian(f, x, y);
...
BOOST_AUTO_TEST_CASE(test_scale_space_gradient)
{
  ...
  auto df = Func{};
  df(x, y, s) = DO::Sara::HalideBackend::scale_space_gradient(f, x, y, s);
...
BOOST_AUTO_TEST_CASE(test_scale_space_hessian)
{
  ...
  auto d2f = Func{};
  d2f(x, y, s) = DO::Sara::HalideBackend::scale_space_hessian(f, x, y, s);
