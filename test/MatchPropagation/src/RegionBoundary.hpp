...
#ifndef DO_REGION_REGIONBOUNDARY_HPP
#define DO_REGION_REGIONBOUNDARY_HPP
...
namespace DO {
  ...
  class RegionBoundary
  {
    ...
    typedef std::multimap<float, size_t> multimap_type;
    template <typename MultiMapIterator_, typename Match_> class Iterator;
  
  public: /* interface */
    //! Typedefs.
    typedef Iterator<multimap_type::const_iterator, const Match> const_iterator;
    typedef Iterator<multimap_type::iterator, Match> iterator;
    
    //! Constructor.
    RegionBoundary(const std::vector<Match>& M) : M_(M) {}
    ...
    bool find(const Match &m) const { return find(&m - &M_[0]); }

    //! Usage: ***KNOW WHAT YOU ARE DOING HERE****
    //! 'const Match& m' MUST refer to ***AN ELEMENT OF THE ARRAY***, i.e.:
    //! 'const std::vector<Match>& M_'
    bool insert(const Match& m) { return insert(&m - &M_[0]); }
    ...
    //! Convenient helper member functions.
  ...
  private: /* iterator class */
    ...
    public: /* interface */
      ...
      inline Iterator(const MultiMapIterator_& map_iter,
        ...
        : map_iter_(map_iter), M_(M) {};
      inline Iterator(const Iterator& it)
        : map_iter_(it.map_iter_), M_(it.M_) {}
      template <typename MultiMapIterator2_, typename Match2_>
      inline Iterator(const Iterator<MultiMapIterator2_, Match2_>& it)
        : map_iter_(it()), M_(it.vector()) {}
      // Assignment operators
      inline Iterator& operator=(const Iterator& it)
      { map_iter_ = it.map_iter_; M_ = it.M_; return *this; }
      // Incrementing/decrementing operators.
      inline Iterator& operator++()
      { ++map_iter_; return *this; }
      inline Iterator& operator--()
      { --map_iter_; return *this; }
      inline Iterator operator++(int)
      { Iterator prev(*this); operator++(); return prev; }
      inline Iterator operator--(int)
      { Iterator prev(*this); operator--(); return prev; }
      ...
      inline const std::vector<Match> *vector() const { return M_; }
...
#endif /* DO_REGION_REGIONBOUNDARY_HPP */