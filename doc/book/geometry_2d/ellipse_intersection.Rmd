...
\begin{equation}
  \mathbf{\Sigma}_{\mathcal{E}} = \mathbf{R}_{\mathcal{E}} \mathbf{D}_{\mathcal{E}} \mathbf{R}_{\mathcal{E}}^\top
  (\#eq:sigma-eps)
\end{equation}
...
\begin{equation}
  (\mathbf{x} - \mathbf{x}_{\mathcal{E}})^\top
...
\begin{equation}
  \mathbf{x}^\top \mathbf{A}_{\mathcal{E}} \mathbf{x} +
  \mathbf{b}_{\mathcal{E}}^\top \mathbf{x} +
  c_{\mathcal{E}} = 0
\end{equation}
...
\begin{align}
  ...
  %
  c_{\mathcal{E}} &= \mathbf{x}_{\mathcal{E}}^\top \mathbf{\Sigma}_{\mathcal{E}}
...
$[1, x, x^2, x^3]^\top$ is in the nullspace of $\mathbf{B}(y)$ where
...
We observe that the vector $[1, x, x^2, x^3]^\top$ can never be zero for any real
...
- the intersection points by $\mathbf{p}_i$ for $i \in [1, L]$, sorted in a
  ...
  \begin{equation}
    \forall i \in [1, L-1],\quad \angle\left([1,0]^\top,
    \mathbf{p}_i\right) \ < \ \angle\left([1,0]^\top, \mathbf{p}_{i+1}\right)
    (\#eq:counterclockwise)
  \end{equation}
