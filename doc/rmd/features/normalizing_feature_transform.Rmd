...
Indeed it makes more sense more logical to transform the elliptic patch into a
circular patch. Only after that, should we look for the dominant gradient on the
circular patch, which will determine the appropriate rotation.
