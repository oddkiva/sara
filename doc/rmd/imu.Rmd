...
Here I write about my own experience as a beginner in
...
- If research papers write that the accelerometers measures the gravity vector,
  why is the norm of recorded acceleration sometimes only about $7.78$ or
  $8.4$ on a car and not equal to $9.81$?
...
- https://www.youtube.com/watch?v=-om0eTXsgnY as shown below.

<p align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/-om0eTXsgnY" frameborder="0" allowfullscreen></iframe>
</p>
...
**pointing up to the sky** and with magnitude close to $9.81 m/s^2$.
...
up. In other words, they have positive elevation $a_z > 0$ and a magnitude
close to $9.81\ m/s^2$.
...
Thus, knowing the spring constant $k$, we can calculate the corresponding
...
- The mass is being pushed:
  ...
  - down by the gravitational force $-m_\text{mass} g$.
  - up by the spring force $k \Delta x$

- The spring is compressed due the mass weight and being pushed:

  - down by the mass reaction force $-m_\text{mass} g$
  - down by its own mass $-m_\text{spring} g$
  - up by the reaction force of the table $R_\text{table}$.

Now the mass-spring system as a whole has two forces acting on it only:

  - up by the reaction force of the table $R_\text{table}$.
  - down by the mass reaction force $-(m_\text{mass} + m_\text{spring}) g$
...
compression, thus $\Delta x \approx 0$. And the accelerometer will measure
accelerations close to zero since $\Delta x \approx 0$.
...
They are easily calculable provided we know the GPS coordinates $(\theta,
