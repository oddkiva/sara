## A Possible Use Case for Animal Conservation
...
But this can be useful too for animal conservation. So instead of talking about
...
more natural: we can image that the ice-floe at the elevation $z = 0 m$ above
the sea if the ice floe is not inclined with respect to the sea.
:::
