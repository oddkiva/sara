#ifndef HALIDE_____my_second_generator_2_h
#define HALIDE_____my_second_generator_2_h
#include <stdint.h>
...
int my_second_generator_2(uint8_t _offset, struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int my_second_generator_2_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *my_second_generator_2_metadata() HALIDE_FUNCTION_ATTRS;
