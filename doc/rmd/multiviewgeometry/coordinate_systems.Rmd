...
To close the section, in fact by generalizing to higher dimensions $n > 3$, this
proposition is the very definition of a rotation matrix: any square matrix
$\mathbf{Q}$ whose tranpose satisfies $\mathbf{Q}^T \mathbf{Q} = \mathbf{I}_n$
